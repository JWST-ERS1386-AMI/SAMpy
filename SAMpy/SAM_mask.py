...
def make_coords(cdir,jwst_filt='f380m',inst='niriss',pscam=0.0656,npix=256,rot=0,xadj=0,yadj=0,pmask=125,sp=20):
    """
    ...
    for i in range(len(bls_uv)):
        if os.path.isfile(cdir+'v2_ind'+str(i)+'.fits')==False:
